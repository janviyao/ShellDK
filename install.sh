...
INST_GUIDE["tclsh8.6"]="${CMD1};install_from_tar 'tcl.+\.tar\.gz'"
...
INST_GUIDE["/usr/sbin/rdma-ndd"]="${CMD1};install_from_rpm 'rdma-core-.+\.rpm'"
INST_GUIDE["/usr/lib64/libibverbs.so.*"]="${CMD1};install_from_rpm 'libibverbs-.+\.rpm'"
