...
openssl;             install_check 'openssl' 'openssl-.+\.tar\.gz$' true;cd ${MY_VIM_DIR}/deps;install_from_tar 'openssl-.+\.tar\.gz' true;rm -fr openssl-*/
