...
INITIATOR_DEBUG_ON=true
ISCSI_MULTIPATH_ON=true
ISCSI_MUTLIPATH_RESTART=true
ISCSI_INITIATOR_RESTART=true
...
kvconf_add "${TEST_SUIT_ENV}" "INITIATOR_DEBUG_ON"        "${INITIATOR_DEBUG_ON}"
kvconf_add "${TEST_SUIT_ENV}" "INITIATOR_LOG_DIR"         "${INITIATOR_LOG_DIR}"
kvconf_add "${TEST_SUIT_ENV}" "ISCSI_MULTIPATH_ON"        "${ISCSI_MULTIPATH_ON}"
kvconf_add "${TEST_SUIT_ENV}" "ISCSI_INITIATOR_LOG"       "${ISCSI_INITIATOR_LOG}"
kvconf_add "${TEST_SUIT_ENV}" "ISCSI_MUTLIPATH_RESTART"   "${ISCSI_MUTLIPATH_RESTART}"
kvconf_add "${TEST_SUIT_ENV}" "ISCSI_INITIATOR_RESTART"   "${ISCSI_INITIATOR_RESTART}"
