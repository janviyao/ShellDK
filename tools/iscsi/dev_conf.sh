...
function conf_sched
{
    ...
    if file_exist "${sys_path}/queue/scheduler";then
...
function conf_merge
{
    ...
    if file_exist "${sys_path}/queue/nomerges";then
...
function conf_qdeep
{
    ...
    if file_exist "${sys_path}/device/queue_depth";then
    ...
    if file_exist "${sys_path}/queue/nr_requests";then
