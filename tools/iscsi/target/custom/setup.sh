...
SPDK_APP_RUNTIME="${SPDK_APP_DIR}/${SPDK_APP_NAME} -m 0XFF --shm-id=1 --iova-mode=va --logflag reactor --logflag thread --logflag iscsi --logflag scsi --logflag bdev --logflag bdev_malloc --wait-for-rpc"
